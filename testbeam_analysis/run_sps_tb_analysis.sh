...
#file_name = "../data/debug/ce65v2_pcb07_hv10_beam_run163220301_240417220307.raw"
#sed "s/\(.*\)/\L\1/g"
...
cp "geometry/${testbeam_alphabetic}-GAP225SQ_HV10.geo" "geometry/${chip}/${testbeam_alphabetic}-${chip}_HV${HV}.geo"
...
#sed -i "s/GAP225SQ_HV10-noisemap/${chip}_HV${HV}-noisemap/g" geometry/${chip}/${testbeam_alphabetic}-${chip}_HV${HV}.geo
sed -i "s/qa\/SPS-GAP225SQ_HV10-noisemap\.root/..\/qa\/${chip}\/${testbeam_alphabetic}-${chip}_HV${HV}-noisemap.root/g" geometry/${chip}/${testbeam_alphabetic}-${chip}_HV${HV}.geo

############################
# Prealign-tel config file #
############################
# copy file from prototype
cp "config/prealign_tel_${testbeam_alphabetic}-GAP225SQ_HV10.conf" "config/${chip}/prealign_tel_${testbeam_alphabetic}-${chip}_HV${HV}.conf"


# update detectors_file(s) file name
sed -i "s/geometry\/SPS-GAP225SQ_HV10/..\/geometry\/${chip}\/${testbeam_alphabetic}-${chip}_HV${HV}/g" config/${chip}/prealign_tel_${testbeam_alphabetic}-${chip}_HV${HV}.conf
...
sed -i "s/SPS-GAP225SQ_HV10/${testbeam_alphabetic}-${chip}_HV${HV}/g" config/${chip}/prealign_tel_${testbeam_alphabetic}-${chip}_HV${HV}.conf
...
sed -i "s/data\/ce65v2_pcb07_hv10_beam_run163220301_240417220307\.raw/..\/data\/${chip}\/ce65v2_${pcb}_hv${HV}_beam_run${run_number_beam}\.raw/g" config/${chip}/prealign_tel_${testbeam_alphabetic}-${chip}_HV${HV}.conf

#########################
# Align-tel config file #
#########################
# copy file from prototype
cp "config/align_tel_${testbeam_alphabetic}-GAP225SQ_HV10.conf" "config/${chip}/align_tel_${testbeam_alphabetic}-${chip}_HV${HV}.conf"

# update detectors_file(s) file name
sed -i "s/geometry\/SPS-GAP225SQ_HV10/..\/geometry\/${chip}\/${testbeam_alphabetic}-${chip}_HV${HV}/g" config/${chip}/align_tel_${testbeam_alphabetic}-${chip}_HV${HV}.conf

# update output file name
sed -i "s/alignment/${chip}\/align/g" config/${chip}/align_tel_${testbeam_alphabetic}-${chip}_HV${HV}.conf

# update file name (should only apply to .root at this point)
sed -i "s/SPS-GAP225SQ_HV10/${testbeam_alphabetic}-${chip}_HV${HV}/g" config/${chip}/align_tel_${testbeam_alphabetic}-${chip}_HV${HV}.conf

# set number_of_events
sed -i "s/number_of_events.*$/number_of_events = ${number_of_events}/g" config/${chip}/align_tel_${testbeam_alphabetic}-${chip}_HV${HV}.conf

# replace inputfilename
sed -i "s/data\/ce65v2_pcb07_hv10_beam_run163220301_240417220307\.raw/..\/data\/${chip}\/ce65v2_${pcb}_hv${HV}_beam_run${run_number_beam}\.raw/g" config/${chip}/align_tel_${testbeam_alphabetic}-${chip}_HV${HV}.conf
...
############################
# copy file from prototype
cp "config/prealign_dut_${testbeam_alphabetic}-GAP225SQ_HV10.conf" "config/${chip}/prealign_dut_${testbeam_alphabetic}-${chip}_HV${HV}.conf"

# update detectors_file(s) file name
sed -i "s/geometry\/SPS-GAP225SQ_HV10/..\/geometry\/${chip}\/${testbeam_alphabetic}-${chip}_HV${HV}/g" config/${chip}/prealign_dut_${testbeam_alphabetic}-${chip}_HV${HV}.conf

# update output file name
sed -i "s/prealignment/${chip}\/prealign/g" config/${chip}/prealign_dut_${testbeam_alphabetic}-${chip}_HV${HV}.conf

# update file name (should only apply to .root at this point)
sed -i "s/SPS-GAP225SQ_HV10/${testbeam_alphabetic}-${chip}_HV${HV}/g" config/${chip}/prealign_dut_${testbeam_alphabetic}-${chip}_HV${HV}.conf
...
# replace inputfilename
sed -i "s/data\/ce65v2_pcb07_hv10_beam_run163220301_240417220307\.raw/..\/data\/${chip}\/ce65v2_${pcb}_hv${HV}_beam_run${run_number_beam}\.raw/g" config/${chip}/prealign_dut_${testbeam_alphabetic}-${chip}_HV${HV}.conf
...
#########################
# copy file from prototype
cp "config/align_dut_${testbeam_alphabetic}-GAP225SQ_HV10.conf" "config/${chip}/align_dut_${testbeam_alphabetic}-${chip}_HV${HV}.conf"

# update detectors_file(s) file name
sed -i "s/geometry\/SPS-GAP225SQ_HV10/..\/geometry\/${chip}\/${testbeam_alphabetic}-${chip}_HV${HV}/g" config/${chip}/align_dut_${testbeam_alphabetic}-${chip}_HV${HV}.conf

# update output file name
sed -i "s/alignment/${chip}\/align/g" config/${chip}/align_dut_${testbeam_alphabetic}-${chip}_HV${HV}.conf

# update file name (should only apply to .root at this point)
sed -i "s/SPS-GAP225SQ_HV10/${testbeam_alphabetic}-${chip}_HV${HV}/g" config/${chip}/align_dut_${testbeam_alphabetic}-${chip}_HV${HV}.conf

# set number_of_events
sed -i "s/number_of_events.*$/number_of_events = ${number_of_events}/g" config/${chip}/align_dut_${testbeam_alphabetic}-${chip}_HV${HV}.conf

# replace inputfilename
sed -i "s/data\/ce65v2_pcb07_hv10_beam_run163220301_240417220307\.raw/..\/data\/${chip}\/ce65v2_${pcb}_hv${HV}_beam_run${run_number_beam}\.raw/g" config/${chip}/align_dut_${testbeam_alphabetic}-${chip}_HV${HV}.conf
...
#########################
# copy file from prototype
cp "config/analysis_${testbeam_alphabetic}-GAP225SQ_HV10.conf" "config/${chip}/analysis_${testbeam_alphabetic}-${chip}_HV${HV}.conf"

# update firstly histogram name
sed -i "s/analysis_SPS-GAP225SQ_HV10_482100624_231128100629_seedthr200_nbh50_snr3_cluster\.root/${chip}\/analysis_${testbeam_alphabetic}-${chip}_${run_number_beam}_seedthr${seedthr_analysis}_nbh${nbh_analysis}_snr${snr_seed_analysis}_${method_analysis}.root/g" config/${chip}/analysis_${testbeam_alphabetic}-${chip}_HV${HV}.conf

# update detectors_file(s) file name
sed -i "s/geometry\/SPS-GAP225SQ_HV10/..\/geometry\/${chip}\/${testbeam_alphabetic}-${chip}_HV${HV}/g" config/${chip}/analysis_${testbeam_alphabetic}-${chip}_HV${HV}.conf

# update file name (should only apply to .root at this point)
sed -i "s/SPS-GAP225SQ_HV10/${testbeam_alphabetic}-${chip}_HV${HV}/g" config/${chip}/analysis_${testbeam_alphabetic}-${chip}_HV${HV}.conf

# set number_of_events
sed -i "s/number_of_events.*$/number_of_events = ${number_of_events}/g" config/${chip}/analysis_${testbeam_alphabetic}-${chip}_HV${HV}.conf

# replace inputfilename
sed -i "s/data\/ce65v2_pcb07_hv10_beam_run163220301_240417220307\.raw/..\/data\/${chip}\/ce65v2_${pcb}_hv${HV}_beam_run${run_number_beam}\.raw/g" config/${chip}/analysis_${testbeam_alphabetic}-${chip}_HV${HV}.conf
...
# sed -i '/type = "ce65v2"/a\
# roi = [[0,0],[0,24],[47,24],[47,0]]' geometry/${chip}/SPS-${chip}_HV${HV}_aligned_dut.conf
...
sed -i '/type = "ce65v2"/a\roi = [[0,0],[0,24],[47,24],[47,0]]' geometry/${chip}/SPS-${chip}_HV${HV}_aligned_dut_iter${niter_align_dut}.conf
